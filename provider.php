...
$cities = ["Attavar", "Adyar", "Akashbhavana", "Bajpe", "Balmatta", "Bejai", "Bolar, Mangalore", "Bondel", "Deralakatte", "Derebail", "Falnir", "Farangipet", "Garodi", "Gurupura", "Haleangadi", "Hampankatte", "Jeppu", "Kadri, Mangalore", "Kankanadi", "Kinnoli", "Kodialbail", "Konaje", "Kudroli", ""];
?>
            ...
            <form action="scripts/updatehall.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="descr" id="descr" class="form-control" cols="30" rows="5"
                        placeholder="Add Discription About Your skill"
                ...
                <div class="form-group">
                    ...
                    <input value="<?= $provider->password; ?>"
                        ...
                        placeholder="Enter 6 Charectar Password" minlength="6" required>
                </div>
